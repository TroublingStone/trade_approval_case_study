...
ACTION_TO_EVENT_TYPE: dict[Action, type[Event]] = {
    Action.SUBMIT: Submitted,
    Action.APPROVE: Approved,
    Action.UPDATE: Updated,
    Action.CANCEL: Cancelled,
    Action.SEND_TO_EXECUTE: SentToExecute,
    Action.BOOK: Booked,
}
...
NON_SUBMIT_VALID_TRANSITIONS = [
    (state, action, ACTION_TO_STATE_MAP[ACTION_TO_EVENT_TYPE[action]])
    for state, action in ALLOWED_TRANSITIONS
